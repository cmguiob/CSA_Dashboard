...
```{r function_barplot_1,  include = TRUE, echo = TRUE }
...
if (!any(range(years) %in% seq(year_1, year_2, by=1))) 
  ...
  theme_minimal()+
    theme(panel.grid = element_blank(),
        ...
        strip.text.x = element_text(margin = margin(1.5,0,1.5,0, "mm"), size = 12, color = "#5D5C58"),
...
```{r barplot_1, include= TRUE, echo = TRUE}
